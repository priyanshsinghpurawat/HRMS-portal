...
// Base body schema to define education fields
...
// addEducationSchema applies refine on the base schema
export const addEducationSchema = z.object({
    body: educationBodySchema.refine(data => {
...
// updateEducationSchema makes the base schema fields optional
